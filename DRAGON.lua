...
sudo_users = {SUDO,1944028567,400099998887777,10589490701058949070}   
...
local Name = 'مطور البوت الفرعون اهو 🌚💞 -\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/AP_XO"..result.username_..""},
},
{
{text = '00:00', url="t.me/AP_XO"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AP_XO/831&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
